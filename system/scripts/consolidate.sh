...
MEMORY_MD="$HOME/.claude/projects/-Users-mrap-mrap-hex/memory/MEMORY.md"
if [ -f "$MEMORY_MD" ]; then
...
if [ -d "$HOME/.claude/projects/-Users-mrap-mrap-hex/memory" ]; then
  MEM_DIR="$HOME/.claude/projects/-Users-mrap-mrap-hex/memory"
